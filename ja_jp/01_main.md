...
適切な権利処理がされていることが明らかではない生成AIを使用する場合、その生成物については区別・明記して取り扱うものとします。その生成物が成果物ではないことはもとより、中間物である場合でも同様に扱います。
...
なおプロンプト内にイラストレーター名を指定するなど、LoRAを直接使用しなくても同様の目的をもって生成を指示する場合は同様の扱いとします。
...
- 2025年11月13日　生成AIを使用した場合の取り扱いの区別について基本方針に追加。プロンプトでのイラストレーター等指定について、LoRAと同様に取り扱う旨を追記。
